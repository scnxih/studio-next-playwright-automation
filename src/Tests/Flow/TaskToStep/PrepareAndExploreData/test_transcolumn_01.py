...
from src.Pages.StudioNext.Center.Flow.DetailsPane.PrepareAndExploreData.transform_columns_pane import \
    TransformColumnsPane
...
"""
    ...
    transform_columns_pane = TransformColumnsPane(page)
