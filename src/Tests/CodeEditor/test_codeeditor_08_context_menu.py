"""
File: test_codeeditor_08_context_menu.py
...
def test_02_custom_code_dialog_context_menu(page, init):
    ...
    # custom_code_editor.context_menu.click_menu_item_by_text(Helper.data_locale.RUN)
    ...
    # Arouse context menu to run code
    # custom_code_editor.open_context_menu()
    # custom_code_editor.context_menu.click_menu_item_by_text(Helper.data_locale.RUN)
...
def test_03_autoexec_dialog_context_menu(page, init):
    ...
    # OBSOLETE
    # autoexec_editor.open_context_menu()
    # autoexec_editor.context_menu.click_menu_item_by_text(Helper.data_locale.RUN)
