...
@description: define Query page -> Select Filter Groups tab, include elements and functionalities in this tab
"""
...
class SelectFilterGroups(BasePage):
    ...
    def switch_to_expression_builder_editor(self):
        ...
        if Alert(self.page, Helper.data_locale.EXPRESSION_BUILDER_TITLE).is_open():
            Alert(self.page, Helper.data_locale.EXPRESSION_BUILDER_TITLE).click_button_in_footer(Helper.data_locale.CONTINUE)
