...
class CoreDecompositionPane(BasicStepPane):
    ...
    def set_max_time(self, radio_btn_value: str):
        self.set_option_for_radio_group(Helper.data_locale.MAXIMUM_TIME, item_value=radio_btn_value)
    ...
    def select_procedure(self, proc: str):
        self.set_option_for_radio_group(Helper.data_locale.CODE_GENERATION, item_value=proc)
