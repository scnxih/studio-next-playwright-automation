...
class CanonicalCorrelationPane(BasicStepPane):
    ...
    def set_check_prefix_label_for_var_set1(self):
        self.set_check_for_checkbox(label=Helper.data_locale.PREFIX_LABEL_FOR_VAR_SET_1)

    def set_uncheck_prefix_label_for_var_set1(self):
        self.set_uncheck_for_checkbox(label=Helper.data_locale.PREFIX_LABEL_FOR_VAR_SET_1)

    def set_check_prefix_label_for_var_set2(self):
        self.set_check_for_checkbox(label=Helper.data_locale.PREFIX_LABEL_FOR_VAR_SET_2)

    def set_uncheck_prefix_label_for_var_set2(self):
        self.set_uncheck_for_checkbox(label=Helper.data_locale.PREFIX_LABEL_FOR_VAR_SET_2)
    ...
    def add_column_for_freq_count(self, column_name: str):
    ...
    def delete_column_for_freq_count(self):
        self.delete_column(parent_label=Helper.data_locale.FREQUENCY_COUNT)
    ...
    def set_check_canonical_redundancy_stat(self):
        self.set_check_for_checkbox(label=Helper.data_locale.CANONICAL_REDUNDANCY_STAT)

    def set_uncheck_canonical_redundancy_stat(self):
        self.set_uncheck_for_checkbox(label=Helper.data_locale.CANONICAL_REDUNDANCY_STAT)

    def set_check_specify_num_of_canonical_variates(self):
        self.set_check_for_checkbox(label=Helper.data_locale.SPECIFY_NUM_OF_CANONICAL_VARIATES)

    def set_uncheck_specify_num_of_canonical_variates(self):
        self.set_uncheck_for_checkbox(label=Helper.data_locale.SPECIFY_NUM_OF_CANONICAL_VARIATES)

    def set_check_perform_regression(self):
        self.set_check_for_checkbox(label=Helper.data_locale.PERFORM_REGRESSION)

    def set_uncheck_perform_regression(self):
        self.set_uncheck_for_checkbox(label=Helper.data_locale.PERFORM_REGRESSION)

    def set_check_canonical_var_score_plots(self):
        self.set_check_for_checkbox(label=Helper.data_locale.CANONICAL_VAR_SCORE_PLOTS)

    def set_uncheck_canonical_var_score_plots(self):
        self.set_uncheck_for_checkbox(label=Helper.data_locale.CANONICAL_VAR_SCORE_PLOTS)
    ...
    def set_regression_type(self, item_index: int = None, item_value: str = None):
        self.set_option_for_combobox(parent_label=Helper.data_locale.REGRESSION_TYPE, item_index=item_index,
                                     item_value=item_value)

    def expand_windowshade_regression_stat(self):
        self.expand_windowshade(parent_label=Helper.data_locale.REGRESSION_STAT)

    def collapse_windowshade_regression_stat(self):
        self.collapse_windowshade(parent_label=Helper.data_locale.REGRESSION_STAT)

    def set_check_regression_coefficients(self):
        self.set_check_for_checkbox(label=Helper.data_locale.REGRESSION_COEFFICIENTS)

    def set_uncheck_regression_coefficients(self):
        self.set_uncheck_for_checkbox(label=Helper.data_locale.REGRESSION_COEFFICIENTS)

    def set_check_standardized_regression_coefficients(self):
        self.set_check_for_checkbox(label=Helper.data_locale.STANDARDIZED_REGRESSION_COEFFICIENTS)

    def set_uncheck_standardized_regression_coefficients(self):
        self.set_uncheck_for_checkbox(label=Helper.data_locale.STANDARDIZED_REGRESSION_COEFFICIENTS)

    def set_check_standard_error_of_coefficients(self):
        self.set_check_for_checkbox(label=Helper.data_locale.STANDARD_ERROR_OF_COEFFICIENTS)

    def set_uncheck_standard_error_of_coefficients(self):
        self.set_uncheck_for_checkbox(label=Helper.data_locale.STANDARD_ERROR_OF_COEFFICIENTS)

    def set_check_t_stat_for_coefficients(self):
        self.set_check_for_checkbox(label=Helper.data_locale.T_STAT_FOR_COEFFICIENTS)

    def set_uncheck_t_stat_for_coefficients(self):
        self.set_uncheck_for_checkbox(label=Helper.data_locale.T_STAT_FOR_COEFFICIENTS)

    def set_check_squared_multiple_correlation(self):
        self.set_check_for_checkbox(label=Helper.data_locale.SQUARED_MULTIPLE_CORRELATION)

    def set_uncheck_squared_multiple_correlation(self):
        self.set_uncheck_for_checkbox(label=Helper.data_locale.SQUARED_MULTIPLE_CORRELATION)

    def expand_windowshade_correlations(self):
        self.expand_windowshade(parent_label=Helper.data_locale.CORRELATIONS)

    def collapse_windowshade_correlations(self):
        self.collapse_windowshade(parent_label=Helper.data_locale.CORRELATIONS)

    def set_check_correlations_of_regression_coefficients(self):
        self.set_check_for_checkbox(label=Helper.data_locale.CORRELATIONS_OF_REGRESSION_COEFFICIENTS)

    def set_uncheck_correlations_of_regression_coefficients(self):
        self.set_uncheck_for_checkbox(label=Helper.data_locale.CORRELATIONS_OF_REGRESSION_COEFFICIENTS)

    def set_check_partial_correlations(self):
        self.set_check_for_checkbox(label=Helper.data_locale.PARTIAL_CORRELATIONS)

    def set_uncheck_partial_correlations(self):
        self.set_uncheck_for_checkbox(label=Helper.data_locale.PARTIAL_CORRELATIONS)

    def set_check_squared_partial_correlations(self):
        self.set_check_for_checkbox(label=Helper.data_locale.SQUARED_PARTIAL_CORRELATIONS)

    def set_uncheck_squared_partial_correlations(self):
        self.set_uncheck_for_checkbox(label=Helper.data_locale.SQUARED_PARTIAL_CORRELATIONS)

    def set_check_semipartial_correlations(self):
        self.set_check_for_checkbox(label=Helper.data_locale.SEMIPARTIAL_CORRELATIONS)

    def set_uncheck_semipartial_correlations(self):
        self.set_uncheck_for_checkbox(label=Helper.data_locale.SEMIPARTIAL_CORRELATIONS)

    def set_check_squared_semipartial_correlations(self):
        self.set_check_for_checkbox(label=Helper.data_locale.SQUARED_SEMIPARTIAL_CORRELATIONS)

    def set_uncheck_squared_semipartial_correlations(self):
        self.set_uncheck_for_checkbox(label=Helper.data_locale.SQUARED_SEMIPARTIAL_CORRELATIONS)
    ...
    def set_check_create_score_dataset(self):
        self.set_check_for_checkbox(label=Helper.data_locale.CREATE_SCORE_DATASET)

    def set_uncheck_create_score_dataset(self):
        self.set_uncheck_for_checkbox(label=Helper.data_locale.CREATE_SCORE_DATASET)

    def set_check_create_stat_dataset(self):
        self.set_check_for_checkbox(label=Helper.data_locale.CREATE_STAT_DATASET)

    def set_uncheck_create_stat_dataset(self):
        self.set_uncheck_for_checkbox(label=Helper.data_locale.CREATE_STAT_DATASET)
