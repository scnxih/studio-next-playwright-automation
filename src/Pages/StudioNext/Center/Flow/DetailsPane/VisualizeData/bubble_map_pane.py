...
class BubbleMapPane(BasicStepPane):
    ...
    def add_column_for_bubble_label(self, column_name: str):
    ...
    def expand_windowshade_bubbles(self):
        self.expand_windowshade(parent_label=Helper.data_locale.BUBBLES)
